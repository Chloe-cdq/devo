...
| related-to | L2-DES-CONV-002 | 1 | specs/L2/conv/L2-DES-CONV-002-two-plane-session-settings-rev-1.md | The settings two-plane write path lands as the pilot domain of Phase B via canonical `session/metadata/update`. |
