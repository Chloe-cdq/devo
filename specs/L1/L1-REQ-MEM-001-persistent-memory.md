...
|---|---|---:|---|---|
| refined-by | L2-DES-MEM-001 | 2 | specs/L2/memory/L2-DES-MEM-001-persistent-memory-architecture-rev-2.md | Defines storage, extraction, retrieval, protocol, settings, lifecycle, and module boundaries. |
